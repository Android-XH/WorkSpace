...
public abstract class ListSwipeMenuRecyclerAdapter<T> extends SwipeMenuRecyclerAdapter<RecyclerHolder> {
    private Context context;
    private List<T> dataList;

    public ListSwipeMenuRecyclerAdapter(Context context) {
        this.context = context;
    }

    public ListSwipeMenuRecyclerAdapter(Context context, List<T> dataList) {
        this(context);
