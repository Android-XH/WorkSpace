...
import com.zbmf.worklibrary.pullrefreshrecycle.progressindicator.AVLoadingIndicatorView;
...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView() {
        ...
        mText.setTextColor(ContextCompat.getColor(getContext(), R.color.black_33));
        addView(mText);
    }
