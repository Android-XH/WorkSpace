package com.zbmf.worklibrary.pullrefreshrecycle.widget;
...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration(Context context) {
        mDivider = ContextCompat.getDrawable(context, R.drawable.divider_list_recycler);
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (isLastRaw(parent, view, spanCount, childCount))// 如果是最后一行，则不需要绘制底部
        {
            outRect.set(0, 0, mDivider.getIntrinsicWidth(), 0);
        } else if (isLastColum(parent, view, spanCount, childCount))// 如果是最后一列，则不需要绘制右边
        {
